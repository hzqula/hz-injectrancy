...
// src -> https://github.com/imranpollob/smart-contract-vulnerability-dataset/blob/master/smart_contract_dataset/escrow_contracts/vulnerable/high/escrow_116.sol

pragma solidity ^0.8.0;

/**
 * @title AssetEscrow
 * @dev A vulnerable asset escrow contract with a 7-day hold period and missing end check.
 * Template: Asset Escrow | Time Dependency: 7-day hold period | Complexity: High
 */
contract AssetEscrow {
    ...
    constructor(address _recipient) {
        ...
        holdEnd = block.timestamp + 7 days;
    }
