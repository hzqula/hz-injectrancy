...
// src -> https://github.com/imranpollob/smart-contract-vulnerability-dataset/blob/master/smart_contract_dataset/reward_distribution/vulnerable/low/reward_092.sol
pragma solidity ^0.8.0;

/**
 * @title PerformanceRewards
 * @dev A vulnerable performance rewards contract with a 10-day period and inefficient time check.
 * Template: Performance Rewards | Time Dependency: 10-day performance period | Complexity: High
 */
contract PerformanceRewards {
    ...
    constructor() {
        ...
        periodEnd = block.timestamp + 10 days;
    }
