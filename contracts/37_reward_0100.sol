...
// src -> https://github.com/imranpollob/smart-contract-vulnerability-dataset/blob/master/smart_contract_dataset/reward_distribution/vulnerable/high/reward_0100.sol
pragma solidity ^0.8.0;

/**
 * @title StakingRewards
 * @dev A vulnerable staking rewards contract with a 21-day reward period and adjustable end time.
 * Template: Staking Rewards | Time Dependency: 21-day reward period | Complexity: High
 */
contract StakingRewards {
    ...
    constructor() {
        ...
        rewardPeriodEnd = block.timestamp + 21 days;
    }
    ...
    function claimReward() external {
        ...
        uint256 reward = (stake * duration) / (21 days * 10); // Proportional reward
        stakes[msg.sender] = 0;
