...
/**
 * @title DisputeEscrow
 * @dev A vulnerable dispute escrow contract with a 20-day dispute period and loose time check.
 * Template: Dispute Escrow | Time Dependency: 20-day dispute period | Complexity: High
 */
contract DisputeEscrow {
    ...
    function resolve(address recipient) external {
        ...
        require(block.timestamp >= disputeEnd || disputed, "Cannot resolve yet");
