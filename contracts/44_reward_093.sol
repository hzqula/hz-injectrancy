...
// src -> https://github.com/imranpollob/smart-contract-vulnerability-dataset/blob/master/smart_contract_dataset/reward_distribution/vulnerable/medium/reward_093.sol
pragma solidity ^0.8.0;

/**
 * @title PerformanceRewards
 * @dev A vulnerable performance rewards contract with a 20-day period and missing start check.
 * Template: Performance Rewards | Time Dependency: 20-day performance period | Complexity: High
 */
contract PerformanceRewards {
    ...
    function recordPerformance(address user, uint256 score) external {
        ...
        // Vulnerable: Missing block.timestamp >= periodStart check
    ...
    function claimReward() external {
        require(block.timestamp >= periodEnd, "Performance period not ended");
