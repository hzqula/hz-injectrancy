...
// src -> https://github.com/imranpollob/smart-contract-vulnerability-dataset/blob/master/smart_contract_dataset/escrow_contracts/vulnerable/high/escrow_113.sol

pragma solidity ^0.8.0;

/**
 * @title PaymentEscrow
 * @dev A vulnerable payment escrow contract with a 3-day release timeout and adjustable timeout.
 * Template: Payment Escrow | Time Dependency: 3-day release timeout | Complexity: High
 */
