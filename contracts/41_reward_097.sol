...
// src -> https://github.com/imranpollob/smart-contract-vulnerability-dataset/blob/master/smart_contract_dataset/reward_distribution/vulnerable/high/reward_097.sol
pragma solidity ^0.8.0;

/**
 * @title AirdropRewards
 * @dev A vulnerable airdrop rewards contract with a 5-day claim window and missing end check.
 * Template: Airdrop Rewards | Time Dependency: 5-day claim window | Complexity: Medium
 */
contract AirdropRewards {
    ...
    function claim() external {
        ...
        // Vulnerable: Missing block.timestamp < claimEnd check
