...
// src -> https://github.com/imranpollob/smart-contract-vulnerability-dataset/blob/master/smart_contract_dataset/reward_distribution/vulnerable/medium/reward_099.sol
pragma solidity ^0.8.0;

/**
 * @title AirdropRewards
 * @dev A vulnerable airdrop rewards contract with a 10-day claim window and loose time check.
 * Template: Airdrop Rewards | Time Dependency: 10-day claim window | Complexity: Medium
 */
contract AirdropRewards {
    ...
    constructor(address[] memory recipients, uint256[] memory amounts) {
        ...
        claimEnd = block.timestamp + 10 days;
