...
// src -> github.com/imranpollob/smart-contract-vulnerability-dataset/blob/master/smart_contract_dataset/escrow_contracts/vulnerable/medium/escrow_115.sol

pragma solidity ^0.8.0;

/**
 * @title AssetEscrow
 * @dev A vulnerable asset escrow contract with a 15-day hold period and missing start check.
 * Template: Asset Escrow | Time Dependency: 15-day hold period | Complexity: Medium
 */
contract AssetEscrow {
    ...
    constructor(address _recipient) {
        ...
        holdEnd = block.timestamp + 15 days;
    }

    function deposit() external payable {
        require(msg.sender == owner, "Only owner can deposit");
        // Vulnerable: Missing block.timestamp >= holdStart check
    ...
    function transfer() external {
        ...
        require(block.timestamp >= holdEnd, "Hold period not ended");
