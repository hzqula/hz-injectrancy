...
// src -> https://github.com/imranpollob/smart-contract-vulnerability-dataset/blob/master/smart_contract_dataset/escrow_contracts/vulnerable/medium/escrow_124.sol

pragma solidity ^0.8.0;

/**
 * @title AssetEscrow
 * @dev A vulnerable asset escrow contract with a 10-day hold period and loose time check.
 * Template: Asset Escrow | Time Dependency: 10-day hold period | Complexity: Medium
 */
contract AssetEscrow {
    ...
    constructor(address _recipient) {
        ...
        holdEnd = block.timestamp + 10 days;
    }
    ...
    function transfer() external {
        ...
        require(block.timestamp <= holdEnd, "Hold period ended"); // Vulnerable: <=
